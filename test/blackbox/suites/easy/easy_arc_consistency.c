...
TEST easy_arc_consistency_one(void) {
...
TEST easy_arc_consistency_two(void) {
...
TEST easy_arc_consistency_three(void) {
...
TEST easy_arc_consistency_four(void) {
...
TEST easy_arc_consistency_five(void) {
...
SUITE (easy_arc_consistency) {
    // 4x4
    RUN_TEST(easy_arc_consistency_one);
    RUN_TEST(easy_arc_consistency_two);
    RUN_TEST(easy_arc_consistency_three);
    RUN_TEST(easy_arc_consistency_four);
    RUN_TEST(easy_arc_consistency_five);
}
