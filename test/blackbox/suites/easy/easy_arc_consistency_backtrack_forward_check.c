...
TEST easy_arc_consistency_backtrack_forward_check_one(void) {
...
TEST easy_arc_consistency_backtrack_forward_check_two(void) {
...
TEST easy_arc_consistency_backtrack_forward_check_three(void) {
...
TEST easy_arc_consistency_backtrack_forward_check_four(void) {
...
SUITE (easy_arc_consistency_backtrack_forward_check) {
    ...
    RUN_TEST(easy_arc_consistency_backtrack_forward_check_three);
    RUN_TEST(easy_arc_consistency_backtrack_forward_check_four);
    RUN_TEST(easy_arc_consistency_backtrack_forward_check_five);
}
