...
SUITE (medium_backtrack_forward_check) {
    // 10 x 13
    RUN_TEST(medium_backtrack_forward_check_one);
    RUN_TEST(medium_backtrack_forward_check_two);
    RUN_TEST(medium_backtrack_forward_check_three);
    RUN_TEST(medium_backtrack_forward_check_four);
    RUN_TEST(medium_backtrack_forward_check_five);
}
